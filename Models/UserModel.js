...
exports.getUserBriefInfo = function (userIDs, callback) {
    ...
    exports.userModel.find({$or:condition},{password:0}).exec(callback);
};
...
exports.searchFriend = function (targetID, callback) {
    ...
    exports.userModel.find(query,{password:0}, callback);
};

exports.addUser = function (user, callback) {
     new exports.userModel(user).save(callback);
};

exports.clear = function (callback) {
    exports.userModel.remove({}, function(err){
        if(err) {
            callback(err);
        } else {
            callback(null);
